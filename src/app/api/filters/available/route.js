...
export async function GET() {
  ...
  const filters = [
    ...
    { type: "string", field: "location_ne_country", label: "Country" },
    {
      type: "string",
    ...
    { type: "string", field: "station_ar_genre", label: "Station Genre" },
    {
      type: "string",
    ...
    { type: "string", field: "artist_sp_name", label: "Artist Name" },
    {
      type: "string OR conditional (greater, lesser, between)",
    ...
    { type: "string", field: "track_sp_name", label: "Track Name" },
    {
      type: "string OR conditional (greater, lesser, between)",
